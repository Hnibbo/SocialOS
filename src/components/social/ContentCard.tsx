...
import { Heart, MessageCircle, Share2, MoreHorizontal, Bookmark, Eye, Smile } from 'lucide-react';
    ...
    return (
        <Card className="w-full max-w-md overflow-hidden bg-gray-900/40 backdrop-blur border-gray-800 hover:border-gray-700 transition-colors">
            ...
            <CardContent className="p-4 py-2">
                {content.caption && (
                    <p className="text-sm text-gray-200 mb-2 whitespace-pre-wrap" dangerouslySetInnerHTML={{ __html: parseContent(content.caption) }} />
                )}
                ...
                <div className="flex gap-2 justify-center w-full">
                    {['❤️', '👍', '🔥', '😂', '🎉'].map((reaction) => (
                        <Button
                            ...
                            onClick={() => onReaction?.(content.id, reaction)}
                        >
