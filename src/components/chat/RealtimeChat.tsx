...
import { Send, User, RefreshCw, AlertCircle, Loader2 } from "lucide-react";
...
export default function RealtimeChat({ roomId }: RealtimeChatProps) {
    const { messages, sendMessage, isConnected, loading, isTyping, sendTypingIndicator, retryMessage } = useRealtimeChat(roomId);
