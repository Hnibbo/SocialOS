                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updatePreference('enable_push_notifications', checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    checked={preferences?.notification_vibrate}
                                    onCheckedChange={(checked) => updatePreference('notification_vibrate', checked)}
                                />
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {Object.entries(preferences?.notification_types || {}).map(([key, value]) => (
                                    <div key={key} className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
                                        ...
                                        <Switch
                                            checked={value}
                                            onCheckedChange={(checked) => updatePreference(`notification_types.${key}`, checked)}
                                        />
                                    </div>
                                ))}
                            </div>
                    ...
                    <GlassCard className="p-6 space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(checked) => updatePreference('enable_email_notifications', checked)}
                            />
                        </div>
                        ...
                        <div className="space-y-4 pt-6 border-t border-white/10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                {Object.entries(preferences?.email_notification_types || {}).map(([key, value]) => (
                                    <div key={key} className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
                                        <Label className="capitalize">{key.replace('_', ' ')}</Label>
                                        <Switch
                                            checked={value}
                                            onCheckedChange={(checked) => updatePreference(`email_notification_types.${key}`, checked)}
                                        />
                                    </div>
                                ))}
                            </div>
