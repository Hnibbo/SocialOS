...
import { LayoutDashboard, Activity, MessageSquare, Zap } from "lucide-react";
    ...
    return (
        <nav className="fixed bottom-8 left-0 right-0 z-50 flex justify-center pointer-events-none">
            <motion.div
                ...
                className="pointer-events-auto bg-black/60 backdrop-blur-3xl border border-white/10 rounded-full h-18 px-8 shadow-[0_20px_50px_rgba(0,0,0,0.5)] flex items-center gap-10"
            >
                {navItems.map((item) => {
