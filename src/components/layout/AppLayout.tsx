...
import { OrganizationSwitcher } from "@/components/identity/OrganizationSwitcher";
    ...
    return (
        <div className="min-h-screen bg-background text-foreground flex overflow-hidden pt-12">
            ...
            <div className="flex-1 flex flex-col min-w-0 lg:ml-64">
                ...
                <div className="lg:flex lg:items-center lg:justify-end lg:p-4 hidden gap-2">
