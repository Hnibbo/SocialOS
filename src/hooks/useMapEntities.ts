    ...
    useEffect(() => {
        ...
        const fetchEntities = async () => {
            ...
            try {
                ...
                // Fetch in parallel using p_ prefix to avoid SQL naming collisions with output columns
                const [users, activities, groups, drops, assets] = await Promise.all([
                    ...
                    supabase.rpc('find_nearby_activities', { p_lat: latitude, p_lng: longitude, p_radius_meters: 50000 }),
                    supabase.rpc('find_nearby_groups', { p_lat: latitude, p_lng: longitude, p_radius_meters: 50000 }),
