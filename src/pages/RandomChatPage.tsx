    ...
    return (
        <div className="fixed inset-0 bg-black text-white overflow-hidden flex flex-col z-50">
            ...
            <div className="flex-1 relative flex flex-col md:flex-row gap-2 p-2 pt-24 pb-32">
                ...
                <div className="absolute bottom-36 right-6 w-40 h-56 md:relative md:bottom-0 md:right-0 md:w-72 md:h-full rounded-[2rem] overflow-hidden bg-slate-800 border-2 border-primary/50 shadow-2xl z-10 transition-all">
                    <video
                        ref={localVideoRef}
                        autoPlay
                        muted
                    ...
                    <div className="absolute top-4 right-4 bg-black/50 p-1.5 rounded-lg border border-white/10">
