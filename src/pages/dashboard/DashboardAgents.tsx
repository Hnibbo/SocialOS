...
export default function DashboardAgents() {
    ...
    const fetchInstalledAgents = async () => {
      ...
      `)
        ...
        // explicit cast to UserInstalledAgent[] since the join query structure matches our type
        setInstalledAgents(data as unknown as UserInstalledAgent[]);
    };
    ...
    const fetchTraces = async () => {
        ...
        setTraces(data as unknown as AgentTrace[]);
    };
