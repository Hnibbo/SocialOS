...
import { TwoFactorAuth } from "@/components/safety/TwoFactorAuth";
import { BlockedUsers } from "@/components/safety/BlockedUsers";
import { MutedUsers } from "@/components/safety/MutedUsers";
        ...
        >
          <Tabs defaultValue="profile" className="space-y-6">
            ...
            <TabsContent value="notifications" className="mt-0">
              ...
              <div className="mt-8 p-8 rounded-[2.5rem] glass-card border-border/50 relative overflow-hidden">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive updates and digests via email.</p>
                  </div>
                </div>
                ...
                <div className="space-y-8 max-w-2xl">
                  <div className="flex items-center justify-between p-6 rounded-2xl bg-muted/10 border border-border/50">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">Receive emails for important events and updates.</p>
                    </div>
                    <Switch
                      checked={emailPreferences?.enable_email_notifications ?? true}
                      onCheckedChange={(checked) => updateEmailPreferences({
                        ...emailPreferences!,
                  ...
                  {emailPreferences?.enable_email_notifications && (
                    <>
                      <div className="space-y-4 p-6 rounded-2xl bg-muted/10 border border-border/50">
                        <h4 className="font-bold">Email Notification Types</h4>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Switch
                              checked={emailPreferences.email_notification_types.daily_digest}
                              onCheckedChange={(checked) => updateEmailPreferences({
                                ...emailPreferences,
                                email_notification_types: {
                                  ...emailPreferences.email_notification_types,
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">Get a weekly overview of your activity</p>
                            </div>
                            <Switch
                              checked={emailPreferences.email_notification_types.weekly_summary}
                              onCheckedChange={(checked) => updateEmailPreferences({
                                ...emailPreferences,
                                email_notification_types: {
                                  ...emailPreferences.email_notification_types,
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">Get notified about important platform updates</p>
                            </div>
                            <Switch
                              checked={emailPreferences.email_notification_types.important_updates}
                              onCheckedChange={(checked) => updateEmailPreferences({
                                ...emailPreferences,
                                email_notification_types: {
                                  ...emailPreferences.email_notification_types,
                                  important_updates: checked,
                                },
                              })}
                            />
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">Receive promotions and marketing communications</p>
                            </div>
                            <Switch
                              checked={emailPreferences.email_notification_types.marketing}
                              onCheckedChange={(checked) => updateEmailPreferences({
                                ...emailPreferences,
                                email_notification_types: {
                                  ...emailPreferences.email_notification_types,
                      ...
                      <div className="flex items-center gap-4">
                        <Button variant="outline" onClick={sendTestEmail} className="gap-2">
                          <Mail className="w-4 h-4" />
                          Send Test Email
                        </Button>
                        <p className="text-xs text-muted-foreground">
                          Sends a test email to verify your notification settings.
                        </p>
                      </div>
                    </>
                  )}
