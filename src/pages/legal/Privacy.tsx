        ...
        <div className="min-h-screen bg-black text-gray-300 p-8 pb-32">
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mt-8 mb-4">3. Consent Management</h2>
                        <p className="text-gray-300">
                            We provide granular control over your consent preferences through our consent management system. You can manage your preferences at any time by:
                        </p>
                        <ul className="list-disc pl-5 space-y-3 text-gray-300">
                            <li>Using the consent banner that appears on your first visit</li>
                            <li>Visiting the Privacy Settings page in your account</li>
                            <li>Clearing your browser cookies and revisiting the site</li>
                        </ul>
                        <p className="text-gray-300 mt-4">
                            We offer four consent categories:
                        </p>
                        <ul className="list-disc pl-5 space-y-3 text-gray-300">
                            <li><strong>Essential</strong>: Required for the platform to function properly. Cannot be disabled.</li>
                            <li><strong>Analytics</strong>: Helps us understand how visitors interact with our website to improve features.</li>
                            <li><strong>Marketing</strong>: Enables us to send you personalized content and offers.</li>
                            <li><strong>Functional</strong>: Enhances your experience with additional features like saved preferences.</li>
                        </ul>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-white mt-8 mb-4">4. Cookie Policy</h2>
                        <p className="text-gray-300">
                            We use cookies and similar technologies to:
                        </p>
                        <ul className="list-disc pl-5 space-y-3 text-gray-300">
                            <li><strong>Session Cookies</strong>: Maintain your session while you're logged in. Expire when you close your browser.</li>
                            <li><strong>Analytics Cookies</strong>: Track usage patterns to improve our service. Expire after 1 year.</li>
                            <li><strong>Marketing Cookies</strong>: Deliver personalized content and offers. Expire after 1 year.</li>
                            <li><strong>Functional Cookies</strong>: Remember your preferences. Expire after 1 year.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-3 text-gray-300">
                            <li><strong>User Data</strong>: 365 days after account deletion</li>
                            <li><strong>Session Data</strong>: 15 minutes after session ends</li>
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mt-8 mb-4">6. Your Rights Under GDPR</h2>
                        <p className="text-gray-300">
                        ...
                        <p className="text-gray-300 mt-4">
                            To exercise any of these rights, please contact us through the GDPR request form in your account settings.
                        </p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-bold text-white mt-8 mb-4">7. Data Protection</h2>
                        <p className="text-gray-300">
                            We take data protection seriously and implement the following measures:
                        </p>
                        <ul className="list-disc pl-5 space-y-3 text-gray-300">
                            <li><strong>Encryption</strong>: Data is encrypted in transit and at rest</li>
                            <li><strong>Access Control</strong>: Role-based access to sensitive data</li>
                            <li><strong>Security Audits</strong>: Regular security audits and penetration testing</li>
                            <li><strong>Incident Response</strong>: 72-hour breach notification policy</li>
                        </ul>
                    </section>
