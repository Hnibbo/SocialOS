...
import { CityEnergyDisplay } from '@/components/features/CityEnergyDisplay';
import { MomentDropsFeed } from '@/components/features/MomentDropsFeed';
import { SocialRolesDisplay } from '@/components/features/SocialRolesDisplay';
import { CityChallengesFeed } from '@/components/features/CityChallengesFeed';
        ...
        <div className="min-h-screen bg-[radial-gradient(circle_at_50%_0%,rgba(139,92,246,0.15),transparent_50%)] p-4 md:p-8 pb-32">
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <CityEnergyDisplay city="San Francisco" neighborhood="SoMa" />
