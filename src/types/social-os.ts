...
export interface UserProfile {
    ...
    visibility_matrix: Record<string, unknown> | null;
...
export interface ContentBlock {
    type: 'heading' | 'paragraph' | 'image' | 'list' | 'code' | 'quote' | 'divider';
    content: string;
    level?: number;
    items?: ContentBlock[];
    language?: string;
...
export interface SecurityRule {
    id: string;
    rule_type: 'rate_limit' | 'content_filter' | 'auth' | 'geo_restriction';
    rule_name: string;
...
export interface Asset {
    ...
    name: string;
    description: string | null;
    type: 'badge' | 'avatar' | 'background' | 'effect' | 'emote' | 'theme';
    media_url: string;
    thumbnail_url: string | null;
    rarity: 'common' | 'uncommon' | 'rare' | 'epic' | 'legendary';
    cost_credits: number;
...
// User Asset Purchases
export interface UserAssetPurchase {
    id: string;
    user_id: string;
    asset_id: string;
    purchase_type: 'credits' | 'hup' | 'real';
